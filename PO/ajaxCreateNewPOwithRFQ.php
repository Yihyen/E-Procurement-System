...
if(isset($_GET["poWithRfq"])){
    ...
    $sql="INSERT INTO purchaseorder (po_id, pr_id, company_id, storageLocation, ship_to_address, po_status, supplierAccNo)".
        "VALUES('$po',NULL, 'C0001','$storageLocation', '$ship_to_address','$po_status', '$supplierAccNo')";
    ...
    if($result){
        for($i = 0; $i < count($rowItemDetails); $i++){
            ...
            $sql2 ="INSERT INTO po_details (po_id, supplierID, po_documentType, po_Date, po_delivery_date, item_id, po_itemQty, po_itemPrice, po_orderTotal, po_remark) VALUES ('$po', '$supplier_id', 'PO with Reference', '$po_Date','$po_delivery_date','$item_id','$po_itemQty','$po_itemPrice','$po_total','$po_remark')";
