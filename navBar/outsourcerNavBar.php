    ...
    <body>
        <div class="sidebar close">
            ...
            <ul class="nav-links">
                ...
                <li>
                    <a href="../outsources/outsourcesApprove.php">
                        <i class='bx bx-purchase-tag-alt' ></i>
                        <span class="link_name">Approve Status</span>
                    </a>
                    <ul class="sub-menu blank">
                        <li><a class="link_name" href="../outsources/outsourcesApprove.php?id=$id">Approve Status</a></li>
                    </ul>
                </li>
