                    ...
                    <div class="card-body">
                        ...
                        if(isset($_GET['outsourcer_id']))
                        {
                            ...
                            if(mysqli_num_rows($query_run) > 0){
                                ...
                                ?>
                                    <div class="mb-3">
                                        <label>Outsourcer ID &nbsp &nbsp &nbsp &nbsp :</label><b> <?=$outsourcer['outsourcer_id'];?></b>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                     ...
                                     <div class="mb-3">
                                            ...
                                            <?php
                                                    if ($outsourcer['status'] == 'Invited') {
                                                        echo "<span class='badge badge-warning'>Invited</span>";
                                                    } else if($outsourcer['status'] == 'Accept') {
