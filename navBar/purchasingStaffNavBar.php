            ...
            <ul class="nav-links">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="#">Supplier Self-application</a></li>
                        <li class="oo"><a href="../potentialSupplier/potential.php" class="fas fa-chevron-right"> &nbsp Potential List</a></li>
                        <li class="oo"><a href="../selfApplication/statusStaff.php" class="fas fa-chevron-right"> &nbsp Status</a></li>
                        <li><a href="../supplierRatingModule/index.php">Supplier Rating</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="../rfqModule/index.php">Maintain Quotation</a></li>
                    </ul>
                </li>
                <li>
                    <div class="iocn-link">
                        <a href="#">
                            ...
                            <span class="link_name">Outsource</span>
                        </a>
                        <i class='bx bxs-chevron-down arrow' ></i>
                    </div>
                    <ul class="sub-menu">
                        <li><a class="link_name" href="#">Outsource</a></li>
                        <li><a href="../outsources/outsourcer.php">Maintain Outsource</a></li>
                        <li><a href="../outsources/outsourcesList.php">Outsource List</a></li>
                        <li><a href="../outsources/status.php">Outsource Status</a></li>
                    </ul>
                </li>
                <li>
                    <div class="iocn-link">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="../catalog/catalog.php">Manage Catalog</a></li>
                    </ul>
                </li>
                <li>
                    <div class="iocn-link">
                        <a href="../rfqModule/index.php">
                            ...
                            <span class="link_name">RFQ</span>
                        </a>
                        <i class='bx bxs-chevron-down arrow' ></i>
                    </div>
                    <ul class="sub-menu">
                        <li><a class="link_name" href="../rfqModule/index.php">RFQ</a></li>
                        <li><a href="../rfqModule/index.php">Create RFQ</a></li>
                    </ul>
                </li>
