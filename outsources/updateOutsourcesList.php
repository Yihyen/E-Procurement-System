...
<head>
    ...
    <title>Update Outsources List</title>
</head>
<body>
                    ...
                    <div class="card-body">
                      <?php
                        if(isset($_GET['id'])){
                           ...
                           $query = "SELECT * FROM outsourcerlist WHERE id='$id' ";
                           $query_run = mysqli_query($con, $query);
                            ...
                            if(mysqli_num_rows($query_run) > 0){
                                ...
                                <form action="codeDatabase.php" enctype="multipart/form-data" method="POST">
                                    <div class="mb-3">
                                        <input type="hidden" name="id" value="<?=$outsourcer['id'];?>" class="form-control" id = "id" readonly>
                                    </div>
                                    <div class="mb-3">
                                        <label>Company Name:</label>
                                        <input type="text" name="outsourcerName" value="<?=$outsourcer['outsourcerName'];?>" id="outsourcerName" class="form-control" placeholder="Enter company name" onkeyup="checkName()" required>
                                    </div>
                                    <div class="icons">
                                    ...
                                    <div class="mb-3">
                                        <label>Email:</label>
                                        <input onkeyup="checkEmail()" type="text" name="email" value="<?=$outsourcer['email'];?>" id="email" class="form-control" placeholder="Enter email" required>
                                    </div>
                                    <div class="icons">
