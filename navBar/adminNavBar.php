            ...
            <ul class="nav-links">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="../administration/editCoSettings.php">Company Settings</a></li>
                        <li><a href="../administration/editGeneralSettings.php">General Settings</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="sub-menu blank">
                        <li><a class="link_name" href="../administration/maintainUser.php">User</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="sub-menu blank">
                        <li><a class="link_name" href="../administration/maintainSupplier.php">Supplier</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="sub-menu blank">
                        <li><a class="link_name" href="../administration/maintainInventory.php">Inventory</a></li>
                    </ul>
                </li>
                <li>
                    <a href="../administration/maintainItemCategory.php">
                        <i class='bx bx-category' ></i>
                        <span class="link_name">Item Category</span>
                    </a>
                    <ul class="sub-menu blank">
                        <li><a class="link_name" href="../administration/maintainItemCategory.php">Item Category</a></li>
                    </ul>
                </li>
                <li>
                    <a href="../administration/maintainPurchaseBudget.php">
                        <i class='bx bx-wallet-alt' ></i>
                        <span class="link_name">Purchase Budget</span>
                    </a>
                    <ul class="sub-menu blank">
                        <li><a class="link_name" href="../administration/maintainPurchaseBudget.php">Purchase Budget</a></li>
                    </ul>
                </li>
                <li>
                    <div class="iocn-link">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="../administration/importData.php">Import Data</a></li>
                        <li><a href="../administration/exportData.php">Export Data</a></li>
                    </ul>
                </li>
