...
if (isset($_POST['submit'])) {
    ...
    $_SESSION['coAddress'] = $_POST['coAddress'];
    $_SESSION['coEmail'] = $_POST['coEmail'];
    $_SESSION['contactNo'] = $_POST['contactNo'];
    $_SESSION['bizLicense'] = $_POST['bizLicense'];

    header("Location: ../administration/generalSettings.php");
}
?>

<html>
    <head>
        <title>User Company Details</title>
    ...
    <body>
        <div class="compDetails">
            ...
            <form action = "" method="post" id="coDetails" class="center">
                <!--company name-->
                ...
                <textarea id="coAddress" name="coAddress" rows="4" cols="70" > </textarea> <br>

                <!--company email-->
                <label for="coEmail">Company Email: </label>
                <input type="text" name="coEmail" id = "coEmail" required value=""> <br>

                <!--contact no-->
                <label for="contactNo">Contact No: </label>
                <input type="text" name="contactNo" id = "contactNo" required value=""> <br>

                <!--business license-->
                <label for="bizLicense">Business License: </label>
                <input type="text" name="bizLicense" id = "bizLicense" required value=""> <br>
