    ...
    <body>
        <div class="sidebar close">
            ...
            <ul class="nav-links">
                ...
                <li>
                    <a href="../selfApplication/registerSupplier.php">
                        <i class='bx bx-purchase-tag-alt' ></i>
                        <span class="link_name">Register Supplier</span>
                    </a>
                    <ul class="sub-menu blank">
                        <li><a class="link_name" href=".../selfApplication/registerSupplier.php">Register Supplier</a></li>
                    </ul>
                </li>
                <li>
                    <a href="../selfApplication/statusSupplier.php">
                        <i class='bx bx-detail' ></i>
                        <span class="link_name">Status</span>
                    </a>
                    <ul class="sub-menu blank">
                        <li><a class="link_name" href="../selfApplication/statusSupplier.php">Status</a></li>
                    </ul>
                </li>
