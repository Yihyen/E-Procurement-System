...
if (isset($_POST["submit"])) {
    ...
    if ($uname != "" && $password != "") {
        ...
        if ($count > 0) {
            ...
            if ($row2["user_role"] == "Administrator") {
                header("Location: ../administration/verifyInitialization.php");
            }else{
...
<html>
    ...
    <body>
        <br><br><br><br>
        <h1><b>Procurement System</b></h1> <br>
        <form class="" action="" method="post" autocomplete="off">
            ...
            <input type='submit' name='submit' id = "login" value="Login" class="submit"> <br>
