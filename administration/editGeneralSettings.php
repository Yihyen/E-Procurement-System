...
if (isset($_POST["save"])) {
    ...
    $query = "UPDATE company SET currency = '$currency' WHERE company_id  = '$coID'";
    mysqli_query($con, $query);

    if ($query) {
        echo "<script>alert('Successfully updated!')</script>";
        echo("<script>location.href = '../administration/editGeneralSettings.php';</script>");
    }else{
